...
## Software Setup
When a user (primary user or cargiver) navigates to the website, they will be required to log in to their account. If the user does not have an account, they will be directed to the sign up page and can select their role and create a secure login.

*Notice for Emergency Contacts: SMS text messages will be sent from a toll free number to the phone numbers registered as emergency contacts. Message and data rates may apply. If you do not wish to recieve any messages or do not own a device that is capable of recieving text messages, please notify the primary user. Upon entering a new emergency contact, a text message will be sent to the entered phone number to confirm registration. By replying "Yes", you are agreeing to continue recieving text messages. In the event of an emergency, you may be asked to provide assistance, such as contacting emergency services on behalf of the primary user.*
